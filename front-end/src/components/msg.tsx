...
export default function Msg({
  ...
  const hasThinkContent = msg.thinkContent && msg.thinkContent.trim();
  return (
    <>
      {isQuestion ? (
        <div className="room-msg__container --question" key={msg.id}>
          <p className="room-msg__msg">
            {msg.content}
          </p>
        </div>
      ) : (
        <div className="room-msg__container" key={msg.id}>
          {hasThinkContent ? (
            <div className="room-msg__thinking">
              <button
                className="room-msg__thinking-title"
              ...
              {thinking ? (
                <p className="room-msg__thinking-msg">{msg.thinkContent}</p>
              ) : null}
            </div>
          ) : null}
          {msg.content ? (
            <>
              <Markdown className="room-msg__msg" markdown={msg.content}/>
              <button
                className="room-msg__copy"
